...
func init() {
	...
	addCmd.PersistentFlags().StringVarP(&b.Branch, "branch", "b", "", "Branch")
	...
	addCmd.PersistentFlags().StringVarP(&b.Remote.Org, "org", "o", "", "Organization")
	addCmd.PersistentFlags().StringVarP(&b.Remote.Repo, "repo", "r", "", "Repository")
